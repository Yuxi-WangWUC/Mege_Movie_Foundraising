...
def get_snack():
    ...
    ["M&Ms", "m&m's", "mms", "mm", "m", "b"],    # first desired_snack is M&Ms for inclusion in output
    ...
    desired_snack = ""
    while desired_snack != "x" or desired_snack != "n":
...
add_dollars = ['Ticket', 'Snacks', 'Surcharge', 'Total', 'Subtotal']
